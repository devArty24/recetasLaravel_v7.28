...
@section('content')
    <h2 class="text-center bm-5">Editar Receta: {{$receta->titulo}}</h2>
    ...
    <div class="row justify-content-center mt-5">
        ...
        <form action="{{route("recetas.update",['receta'=>$receta->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="hidden" id="preparacion" name="preparacion" class="form-control" value="{{$receta->preparacion}}">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="hidden" id="ingredientes" name="ingredientes" class="form-control" value="{{$receta->ingredientes}}">
